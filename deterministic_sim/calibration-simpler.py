...
# This is the parameter we aim to calibrate.  An undergraduate in a group with a given number of contacts units
# generates dec_ug_infected_per_day_unit * contact_units infections per day generated during study week in the December
# Omicron surge
...
def main():
    ...
    infections_per_contact = dec_ug_infected_per_day_unit * micro.days_infectious(7,1.5)
    ...
    infections_per_contact = dec_ug_infected_per_day_unit * micro.days_infectious(7,3)
    ...
    plt.title(f"Actual vs. Simulated Infection Trajectories\n"
              f"dec_ug_infected_per_day_unit={dec_ug_infected_per_day_unit}, Symptomatic Rate = {SYMPTOMATIC_RATE}")
