...
if __name__ == "__main__":
    ...
    save_folder = '../../notebooks/vax_sims/fall_2021_prior_samples:{}/'.format(get_timestamp())
    os.mkdir(save_folder)

    os.chdir('../../notebooks/vax_sims/')
    print("kicking off processes now")
    num_cores = multiprocessing.cpu_count()
    results = Parallel(n_jobs=num_cores)(delayed(sample_and_save)(i, save_folder, nsamples=nsamples, T=T) for i in range(10000))
